...
<svelte:head>
	...
	<meta property="og:url" content="https://ruralby.netlify.app/explore/{data.category}" />
	...
	<meta property="twitter:url" content="https://ruralby.netlify.app/explore/{data.category}" />
